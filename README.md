...
**White Moon expansion (Phase 7 build):** Toggle from the New Game screen. Adds 24 villagers across 12 families (8 stacks of 3), 10 new ghost cards including the Devourer ability, Moon Crystals (captured from the Herbalist's white face, spendable like wild Tao), the Portal tile for saving villagers, and the Kung-Fu School tile replacing Night Watchman's Beat. Hauntings kill villagers on the tile instead of flipping it; lose immediately at 12 villager deaths. **Per-family death curses and full-family save rewards** are wired for all 12 families. **Su-Ling** enters play on the first triggering event and cancels the center-stone abilities of the ghost in front of her. **Villager fleeing** triggers on Haunter card→stone 1 transitions; villagers can be carried with a Taoist during a move. Filling all four corner **Receptacles** triggers the **Mystic Barrier** at end of Yang phase — discards the highest-resistance non-incarnation ghost on every board. See the rulebook's *White Moon* topic for what's still simplified.

**Black Secret expansion (Phase 8 build):** Toggle from the New Game screen — the asymmetric expansion that lets one player take the role of Wu-Feng. At every Yin step 3, instead of the ghost auto-placing on its color board, Wu-Feng gets an intervention prompt: **place** the ghost normally, **summon** one of three demons (cost 2/3/4) into the catacombs (the ghost card pays the cost — its resistance must meet the demon's), **throw a curse** matching the ghost's color (black is wild) at a chosen pyramid level with **real per-level effects** (lvl 1 Qi loss, lvl 2 Tao discard, lvl 3 tile haunt, lvl 4 mass Qi loss), or **place a skeleton** (resistance-1 ghost on any free space). **Bloody Mantras accumulate Qi** from every loss; full mantras resolve with **real effects** (lvl 2 mass Qi gain, lvl 3 clears Inactive Tao, lvl 4 mass discard). **Blood Brothers** lets a 1-Qi Taoist use the opposite board's power. **Catacomb tokens** are drawn when demons search — Buddha returns the demon, Cursed Tablet throws a curse, Bones grants a skeleton, Blood of Su-Ling resolves a Mantra, **3 Urns** spawn the Shadow of Wu-Feng. Demons take a Yin-prelude action (default: search) every turn. Adds the Calligrapher tile (replaces Night Watchman). Compatible with White Moon — run both for the full asymmetric+villager experience.
...
- [x] **Phase 8** — Black Secret expansion (Wu-Feng player intervention at every Yin step 3 — place / summon demon / throw curse — with curse pyramid validation, demon-cost validation against ghost resistance, Calligrapher tile replacing Night Watchman. Catacomb tokens, demon movement, individual curse effects, Bloody Mantra resolution, Blood Brothers, Shadow of Wu-Feng, skeleton placement, and online Wu-Feng seat assignment deferred — documented in the rulebook topic.)
